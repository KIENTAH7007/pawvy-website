...
export default async function BrandPage({ params }) {
  ...
  return (
    <>
      ...
      <div className="section-curve" style={{ background: 'var(--navy)', position: 'relative', overflow: 'hidden' }}>
        {heroPhoto && <img src={heroPhoto} alt="" className="subhero-bg-photo" style={{ objectPosition: 'bottom' }} />}
