  ...
  'Puzzle Feeder': {
    ...
    deepDive: {
      ...
      fitCards: {
        ...
        sub: 'Two sizes for slow feeding, plus a play range for extra mental stimulation.',
        items: [
          {
            name: 'Puzzle Feeder', fitFor: 'Suitable for M–L dogs',
            image: '/brand-features/puzzlefeeder/fit-feeder.jpg',
            // Colors sampled directly from the real product photos KT sent
            // (Green, Pink, Swirl-Purple) rather than the older poster's
            // 4-color lineup, which doesn't match what's actually in the
            // catalog right now.
            colors: ['#5C846A', '#A17E78', '#3F2469'],
          },
          {
            name: 'Puzzle Feeder Lite', fitFor: 'Suitable for S–M dogs',
            image: '/brand-features/puzzlefeeder/fit-lite.jpg',
            // Green (Feeder Lite) + Orange (Lick Bowl Lite) — the two real
            // SKUs sent for this card.
            colors: ['#7BB636', '#E2A83D'],
          },
          {
            name: 'Puzzle Enrichment Range', fitFor: 'For extra mental stimulation',
            image: '/brand-features/puzzlefeeder/fit-enrichment.jpg',
            // Card photo is the Lickpop set (KT confirmed) — Tumbler and
            // Mat are real, photographed SKUs too, just not the one shown
            // on this card.
            tags: ['Tumbler', 'Mat', 'Lickpop'],
          },
        ],
      },
    },
