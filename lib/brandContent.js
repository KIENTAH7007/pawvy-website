...
export const BRAND_CONTENT = {
  ...
  'Lillidale': {
    ...
    faqs: [
      ...
      // Covers all three Supplements SKUs in one answer (matches the
      // Salmoil pattern of one shared sizing FAQ rather than one per
      // product) — whichever supplement a customer lands on, the linked
      // answer has their product's table right there alongside the other
      // two, so there's no separate FAQ entry to find per product.
      ['How much should I feed, and how long will each size last?', `
        <p><strong>ProHealth</strong> — daily measure by weight (1 level measure = 3.5g; 5ml scoop included):</p>
        ...
        <p><strong>ProJoint</strong> — daily measure by weight (1 level measure = 10g):</p>
        <div class="faq-table-wrap">
          <table class="faq-table">
            <thead><tr><th>Dog weight</th><th>Maintenance</th><th>Full Support</th></tr></thead>
            <tbody>
        ...
        <p><strong>Plaque Guard</strong> \u2014 daily measure by weight (1 level measure = 1g), 60g jar:</p>
        <div class="faq-table-wrap">
          <table class="faq-table">
