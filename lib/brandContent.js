      ...
      wbGroups: [
        {
          ...
          items: [
            {
              name: 'Anchovy, Turkey & Apple Casserole', fitFor: 'No freezer, no thawing — just serve',
              variants: [{ label: '280g', seriesIncludes: 'Casseroles', variationIncludes: 'Anchovy' }],
            },
            {
              name: 'Salmon, Chicken & Pear Casserole', fitFor: 'No freezer, no thawing — just serve',
              variants: [{ label: '280g', seriesIncludes: 'Casseroles', variationIncludes: 'Salmon' }],
            },
            {
              name: 'Pork & Pumpkin Casserole', fitFor: 'No freezer, no thawing — just serve',
              variants: [{ label: '280g', seriesIncludes: 'Casseroles', variationIncludes: 'Pork' }],
            },
            {
              name: 'Beef & Pineapple Casserole', fitFor: 'No freezer, no thawing — just serve',
