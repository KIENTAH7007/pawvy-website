  ...
  'Puzzle Feeder': {
    ...
    deepDive: {
      ...
      fitCards: {
        ...
        // Split into 6 individual cards per Janice's direction — the
        // earlier 3-consolidated-card version grouped Swirl in with the
        // regular Feeder's colors and folded Lickpop/Tumbler/Mat into one
        // "Enrichment Range" card; this gives every SKU its own card
        // instead (2 rows of 3, grid wraps automatically).
        items: [
          {
            name: 'Puzzle Feeder', fitFor: 'Suitable for M–L dogs',
            image: '/brand-features/puzzlefeeder/fit-feeder.jpg',
            colors: ['#5C846A', '#A17E78'], // Green, Pink
          },
          {
            name: 'Puzzle Feeder Swirl', fitFor: 'A different way to slow feed',
            image: '/brand-features/puzzlefeeder/fit-swirl.jpg',
            colors: ['#3F2469'], // Purple
          },
          {
            name: 'Puzzle Feeder Lite', fitFor: 'Suitable for S–M dogs',
            image: '/brand-features/puzzlefeeder/fit-lite.jpg',
            colors: ['#7BB636', '#E2A83D'], // Green (Feeder Lite), Orange (Lick Bowl Lite)
          },
          {
            name: 'Puzzle Lickpop', fitFor: 'For food-motivated lickers',
            image: '/brand-features/puzzlefeeder/fit-enrichment.jpg',
            colors: ['#9AD16A', '#97D9CC'], // Green / Teal two-tone
          },
          {
            name: 'Puzzle Tumbler', fitFor: 'Roll, dispense, repeat',
            image: '/brand-features/puzzlefeeder/fit-tumbler.jpg',
            colors: ['#FFAA01', '#F4D0C4'], // Orange/Green SKU, Pink/Teal SKU
          },
          {
            name: 'Puzzle Mat', fitFor: 'Great for treats & spreads',
            image: '/brand-features/puzzlefeeder/fit-mat.jpg',
            colors: ['#54B89D'], // Green
          },
        ],
      },
