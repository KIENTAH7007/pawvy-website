        ...
        items: [
          {
            ...
            variants: [
              { label: '125g', hex: '#E8CE85', seriesIncludes: 'Pollack', seriesExcludes: ['Stick'], variationIncludes: '125', image: '/brand-features/eastseabrother/sku-pollack-125.jpg' },
              { label: '60g', hex: '#E8CE85', seriesIncludes: 'Pollack', seriesExcludes: ['Stick'], variationIncludes: '60', image: '/brand-features/eastseabrother/sku-pollack-60.jpg' },
            ],
          },
          {
            name: 'Salmon', fitFor: 'Red fish · 2 sizes',
            variants: [
              { label: '120g', hex: '#E8916E', seriesIncludes: 'Salmon', variationIncludes: '115', image: '/brand-features/eastseabrother/sku-salmon-115.jpg' },
              { label: '55g', hex: '#E8916E', seriesIncludes: 'Salmon', variationIncludes: '55', image: '/brand-features/eastseabrother/sku-salmon-55.jpg' },
            ],
          },
          {
            name: 'Flatfish', fitFor: 'White fish · 2 sizes',
            variants: [
              { label: '110g', hex: '#E8CE85', seriesIncludes: 'Flatfish', variationIncludes: '110', image: '/brand-features/eastseabrother/sku-flatfish-110.jpg' },
              { label: '55g', hex: '#E8CE85', seriesIncludes: 'Flatfish', variationIncludes: '55', image: '/brand-features/eastseabrother/sku-flatfish-55.jpg' },
            ],
          },
          {
            name: 'Capelin', fitFor: 'Whole fish',
            variants: [
              { label: '125g', hex: '#7FB0AA', seriesIncludes: 'Capelin', variationIncludes: '125', image: '/brand-features/eastseabrother/sku-capelin-125.jpg' },
            ],
          },
          {
            name: 'Sandlance', fitFor: 'Whole fish',
            variants: [
              { label: '100g', hex: '#7FB0AA', seriesIncludes: 'Sandlance', variationIncludes: '100', image: '/brand-features/eastseabrother/sku-sandlance-100.jpg' },
            ],
          },
          {
            // Split out from the Pollack card into its own, per KT — the
            // 125g/60g variants above no longer need `seriesExcludes:
            // ['Stick']` since there's no Stick variant left in that card
            // to accidentally match against. Same white-fish color as the
            // Pollack card, since it's the same fish, just a different
            // format (stick-shaped rather than loose pieces).
            name: 'Pollack Stick', fitFor: 'White fish · Dental chew format',
            variants: [
              { label: '70g', hex: '#E8CE85', seriesIncludes: 'Pollack', variationIncludes: 'Stick', image: '/brand-features/eastseabrother/sku-pollack-stick-70.jpg' },
            ],
          },
          {
            name: 'Green Lipped Mussels', fitFor: 'Joint support',
            variants: [
              { label: '70g', hex: '#8DA47E', seriesIncludes: 'Mussel', variationIncludes: '70', image: '/brand-features/eastseabrother/sku-mussels-70.jpg' },
            ],
          },
        ],
      },
