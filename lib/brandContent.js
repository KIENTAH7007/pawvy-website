        ...
        items: [
          {
            ...
            items: ['ProJoint', 'ProHealth', 'Plaque Guard'],
          },
          {
            ...
            items: ['Sanitizing Spray', 'Ear Cleanser', 'Dental Spray', 'Eye Cleanser', 'Wound Care'],
          },
          {
            anchor: 'wellness',
            ...
            items: ['Lazy Wash (no-rinse)', 'Paw & Nose Balm', 'Wound Cream', 'Skin Ointment', 'Sunblock Powder'],
          },
        ],
      },
          ...
          items: [
            {
              ...
              variants: [
                ...
                { label: '2kg', seriesIncludes: 'ProJoint', seriesExcludes: ['Cat'], variationIncludes: '2kg', image: '/brand-features/lillidale/sku-projoint-2kg.jpg' },
              ],
            },
            {
              ...
              variants: [
                ...
                { label: '2kg', seriesIncludes: 'ProHealth', variationIncludes: '2kg', image: '/brand-features/lillidale/sku-prohealth-2kg.jpg' },
              ],
            },
            {
          ...
          items: [
            {
              ...
              variants: [{ label: '500ml', seriesIncludes: 'Sanitizing', image: '/brand-features/lillidale/sku-sanitizingspray.jpg' }],
            },
            {
              name: 'Ear Cleanser', fitFor: '250ml',
              variants: [{ label: '250ml', seriesIncludes: 'Ear Cleanser', image: '/brand-features/lillidale/sku-earcleanser.jpg' }],
            },
            {
              name: 'Dental Spray', fitFor: '250ml',
              variants: [{ label: '250ml', seriesIncludes: 'Dental Spray', image: '/brand-features/lillidale/sku-dentalspray.jpg' }],
            },
            {
            ...
            {
              name: 'Wound Care', fitFor: '100ml',
              variants: [{ label: '100ml', seriesIncludes: 'Wound Care', seriesExcludes: ['Cream'], image: '/brand-features/lillidale/sku-woundcare.jpg' }],
            },
          ],
        },
        {
