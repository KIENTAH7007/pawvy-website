  ...
  'Puzzle Feeder': {
    ...
    deepDive: {
      ...
      fitCards: {
        ...
        // an Add to Cart button (see FitCardAddButton in BrandDeepDive.jsx).
        // `variants` map each visual option to a real catalog product via
        // `match` — a substring searched against the live product list to
        // resolve the actual id/price/image at click time (brandContent.js
        // is static and doesn't know live product IDs). Cards with a
        // single variant add straight to cart; 2+ variants open a picker
        // modal first.
        //
        ...
        // doesn't change the picker UX, just the accuracy of the label.
        items: [
          {
            name: 'Puzzle Feeder', fitFor: 'Suitable for M–L dogs',
            variants: [
              { label: 'Green', hex: '#5C846A', match: 'Puzzle Feeder — Green', image: '/brand-features/puzzlefeeder/fit-feeder-green.jpg' },
              { label: 'Pink', hex: '#A17E78', match: 'Puzzle Feeder — Pink', image: '/brand-features/puzzlefeeder/fit-feeder-pink.jpg' },
            ],
          },
          {
            name: 'Puzzle Feeder Swirl', fitFor: 'A different way to slow feed',
            variants: [
              { label: 'Purple', hex: '#3F2469', match: 'Puzzle Feeder Swirl — Purple', image: '/brand-features/puzzlefeeder/fit-swirl.jpg' },
            ],
          },
          {
            name: 'Puzzle Feeder Lite', fitFor: 'Suitable for S–M dogs',
            variants: [
              { label: 'Green', hex: '#7BB636', match: 'Puzzle Feeder Lite — Green', image: '/brand-features/puzzlefeeder/fit-lite-green.jpg' },
              { label: 'Orange', hex: '#E2A83D', match: 'Puzzle Lick Bowl Lite — Orange', image: '/brand-features/puzzlefeeder/fit-lite-orange.jpg' },
            ],
          },
          {
            name: 'Puzzle Lickpop', fitFor: 'For food-motivated lickers',
            variants: [
              { label: 'Green', hex: '#9AD16A', match: 'Puzzle Lickpop — Green', image: '/brand-features/puzzlefeeder/fit-enrichment.jpg' },
            ],
          },
          {
            name: 'Puzzle Tumbler', fitFor: 'Roll, dispense, repeat',
            variants: [
              { label: 'S/M · Green/Orange', hex: '#FFAA01', match: 'Puzzle Tumbler — S/M', image: '/brand-features/puzzlefeeder/fit-tumbler-orange.jpg' },
              { label: 'L/XL · Pink/Cyan', hex: '#F4D0C4', match: 'Puzzle Tumbler — L/XL', image: '/brand-features/puzzlefeeder/fit-tumbler-pink.jpg' },
            ],
          },
          {
            name: 'Puzzle Mat', fitFor: 'Great for treats & spreads',
            variants: [
              { label: 'Green', hex: '#54B89D', match: 'Puzzle Mat — Green', image: '/brand-features/puzzlefeeder/fit-mat.jpg' },
            ],
          },
        ],
      },
