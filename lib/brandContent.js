  ...
  'Wild Balance': {
    ...
    deepDive: {
      ...
      intro: {
        ...
        heading: "Served the way you'd cook for them yourself",
        body: "Wild Balance makes complete meals and treats using real meat and vegetables — no fillers, no shortcuts. Every recipe is formulated to FEDIAF standards, the European equivalent of AAFCO, and every product is shelf-stable.",
      ...
      wbGroups: [
        {
          ...
          sub: 'Real meat and vegetables in their own natural essence — no freezer, no thawing. Just open the pack and serve.',
          items: [
            {
        ...
        },
        {
          ...
          sub: '90% real meat, cooked low and slow with pumpkin, carrot, and spinach. Shelf-stable until opened.',
          items: [
            {
        ...
        },
        {
          ...
          sub: 'Softness and chew time vary by cut. Not sure which one fits your dog? Use the picker below.',
          items: [
            {
    ...
    faqs: [
      ['What does "FEDIAF standards" entail? How does it compare to AAFCO?',
