...
export const BRAND_CONTENT = {
  'Better Bone': {
    ...
    // Optional deep-dive sections rendered between "Why Pawvy carries..."
    ...
    deepDive: {
      ...
      guide: {
        heading: 'Find The Bone',
        sub: "BetterBone comes in 3 sizes, hardness levels, and flavours. Use the Chew-sing Guide to find the right one that matches your furkid's chewing behavior.",
        // Points at the FAQ section below — KT's confirmed a "Chew-sing
        // Guide" FAQ entry is coming; once that's added, this can be made
        // more specific (e.g. an id on that individual FAQ item).
        ctaLabel: 'Chew-sing Guide',
        ctaHref: '#faq',
      },
    },
  },
